...
let timelineElements = [
  ...
  },
  {
    ...
    description:
      'This is an improved version of the first coffee website I made for Barista Chaw Su. This improved version is built upon Astro, React and SCSS. The design is quite similar but the frameworks used are different. The basic one was http://baristachawsu.great-site.net.',
    date: '2023',
    tag: 'Educational',
    image: CoffeeWebsite,
  },
